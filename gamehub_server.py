...
TRAINING_MAPS = {
    ...
    "cleveland": {
        ...
        "tickets": (
            ("collinwood", "flats", 4),
            ("collinwood", "lakewood", 4),
            ("collinwood", "playhouse", 4),
            ("collinwood", "shaker", 4),
            ("collinwood", "shoreway", 4),
            ("collinwood", "tremont", 4),
            ("collinwood", "university", 4),
            ("collinwood", "warehouse", 4),
            ("collinwood", "west_park", 4),
            ("flats", "heights", 4),
            ("flats", "lakewood", 4),
            ("flats", "little_italy", 4),
            ("flats", "playhouse", 4),
            ("flats", "shoreway", 4),
            ("flats", "university", 4),
            ("flats", "warehouse", 4),
    ...
    "sanfrancisco": {
        ...
        "tickets": (
            ("castro", "dogpatch", 4),
            ("castro", "embarcadero", 4),
            ("castro", "fish_wharf", 4),
            ("castro", "marina", 4),
            ("castro", "pacific_heights", 4),
            ("castro", "presidio", 4),
            ("castro", "richmond", 4),
            ("castro", "sunset", 4),
            ("dogpatch", "fish_wharf", 4),
            ("dogpatch", "haight", 4),
            ("dogpatch", "marina", 4),
            ("dogpatch", "pacific_heights", 4),
            ("dogpatch", "presidio", 4),
            ("dogpatch", "richmond", 4),
            ("dogpatch", "sunset", 4),
            ("embarcadero", "haight", 4),
            ("embarcadero", "marina", 4),
            ("embarcadero", "mission", 4),
            ("embarcadero", "pacific_heights", 4),
            ("embarcadero", "presidio", 4),
        ),
    },
    "seattle": {
        "name": "Seattle",
        ...
        "tickets": (
            ...
            ("capitol", "magnolia", 4),
            ("capitol", "westlake", 4),
            ("capitol", "westseattle", 4),
            ("columbia", "pike_place", 4),
            ("columbia", "westseattle", 4),
            ("greenlake", "magnolia", 4),
            ("greenlake", "westlake", 4),
            ("greenlake", "westseattle", 4),
            ("magnolia", "sodo", 4),
            ("magnolia", "udistrict", 4),
            ("magnolia", "westlake", 4),
        ),
    },
    ...
    "losangeles": {
        ...
        "tickets": (
            ...
            ("boyle", "venice", 4),
            ("burbank", "downtown", 4),
            ("burbank", "santamonica", 4),
            ("downtown", "northridge", 4),
            ("downtown", "pasadena", 4),
            ("downtown", "santamonica", 4),
            ("hollywood", "inglewood", 4),
            ("hollywood", "southla", 4),
            ("hollywood", "venice", 4),
            ("inglewood", "santamonica", 4),
            ("northridge", "pasadena", 4),
            ("northridge", "venice", 4),
            ("pasadena", "santamonica", 4),
            ("pasadena", "southla", 4),
            ("southla", "venice", 4),
            ("boyle", "northridge", 6),
            ("boyle", "santamonica", 6),
    ...
    "atlanta": {
        ...
        "tickets": (
            ("bankhead", "cabbagetown", 4),
            ("bankhead", "decatur", 4),
            ("bankhead", "inman", 4),
            ("bankhead", "lenox", 4),
            ("bankhead", "west_midtown", 4),
            ("cabbagetown", "druid", 4),
            ("cabbagetown", "lenox", 4),
            ("cabbagetown", "vinings", 4),
            ("cabbagetown", "west_end", 4),
            ("cabbagetown", "west_midtown", 4),
            ("decatur", "inman", 4),
            ("decatur", "lenox", 4),
            ("decatur", "midtown", 4),
            ("decatur", "vinings", 4),
            ("decatur", "west_end", 4),
            ("decatur", "west_midtown", 4),
            ("druid", "fivepoints", 4),
            ("druid", "west_midtown", 4),
            ("fivepoints", "midtown", 4),
            ("inman", "lenox", 4),
        ),
    },
    "newyork": {
        ...
        "tickets": (
            ("astoria", "chelsea", 4),
            ("astoria", "greenwich", 4),
            ("astoria", "park_slope", 4),
            ("astoria", "upper_east", 4),
            ("astoria", "upper_west", 4),
            ("astoria", "wallst", 4),
            ("brooklynhts", "greenwich", 4),
            ("brooklynhts", "times_square", 4),
            ("brooklynhts", "williamsburg", 4),
            ("chelsea", "harlem", 4),
            ("chelsea", "tribeca", 4),
    ...
    "melbourne": {
        ...
        "tickets": (
            ("brunswick", "collingwood", 4),
            ("brunswick", "fitzroy", 4),
            ("brunswick", "footscray", 4),
            ("brunswick", "richmond", 4),
            ("brunswick", "southern_cross", 4),
            ("brunswick", "st_kilda", 4),
            ("carlton", "collingwood", 4),
            ("carlton", "north_melbourne", 4),
            ("carlton", "richmond", 4),
            ("carlton", "southern_cross", 4),
            ("carlton", "st_kilda", 4),
            ("collingwood", "southern_cross", 4),
            ("collingwood", "st_kilda", 4),
            ("fitzroy", "richmond", 4),
            ("fitzroy", "southern_cross", 4),
            ("fitzroy", "st_kilda", 4),
            ("flinders", "footscray", 4),
            ("flinders", "north_melbourne", 4),
            ("flinders", "port_melbourne", 4),
            ("footscray", "st_kilda", 4),
        ),
    },
    "sydney": {
        "name": "Sydney",
        ...
        "tickets": (
            ("bankstown", "bondi", 4),
            ("bankstown", "circularquay", 4),
            ("bankstown", "parramatta", 4),
            ("bankstown", "ryde", 4),
            ("blacktown", "central", 4),
            ("blacktown", "chatswood", 4),
            ("blacktown", "manly", 4),
            ("blacktown", "newtown", 4),
            ("bondi", "chatswood", 4),
            ("bondi", "circularquay", 4),
            ("bondi", "newtown", 4),
            ("bondi", "parramatta", 4),
            ("bondi", "ryde", 4),
            ("central", "chatswood", 4),
            ("central", "manly", 4),
            ("circularquay", "coogee", 4),
            ("circularquay", "newtown", 4),
            ("circularquay", "parramatta", 4),
            ("circularquay", "ryde", 4),
            ("coogee", "manly", 4),
        ),
    },
    "detroit": {
        ...
        "tickets": (
            ...
            ("campus", "midtown", 4),
            ("corktown", "eastern", 4),
            ("corktown", "newcenter", 4),
            ("corktown", "riverfront", 4),
            ("corktown", "woodbridge", 4),
            ("eastern", "mexicantown", 4),
            ("eastern", "midtown", 4),
            ("eastern", "newcenter", 4),
            ("eastern", "warrendale", 4),
            ("eastern", "woodbridge", 4),
            ("hamtramck", "riverfront", 4),
            ("hamtramck", "woodbridge", 4),
            ("mexicantown", "newcenter", 4),
            ("mexicantown", "warrendale", 4),
            ("mexicantown", "woodbridge", 4),
            ("midtown", "warrendale", 4),
            ("newcenter", "riverfront", 4),
            ("newcenter", "warrendale", 4),
            ("newcenter", "woodbridge", 4),
        ),
    },
    "minneapolis": {
        "name": "Minneapolis",
        ...
        "tickets": (
            ("calhoun", "downtown", 4),
            ("calhoun", "longfellow", 4),
            ("calhoun", "north_mpls", 4),
            ("dinkytown", "longfellow", 4),
            ("dinkytown", "lynlake", 4),
            ("dinkytown", "seward", 4),
            ...
            ("downtown", "lynlake", 4),
            ("downtown", "nokomis", 4),
            ("longfellow", "north_mpls", 4),
            ("longfellow", "northeast", 4),
            ("longfellow", "st_anthony", 4),
            ("longfellow", "uptown", 4),
            ("lynlake", "nokomis", 4),
            ("nokomis", "seward", 4),
            ("north_mpls", "northeast", 4),
            ("north_mpls", "seward", 4),
            ("north_mpls", "st_anthony", 4),
            ("north_mpls", "uptown", 4),
        ),
    },
}
